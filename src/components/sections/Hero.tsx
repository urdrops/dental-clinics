...
const trustBadges = [
  { icon: <Users size={20} />, text: "2000+ пациентов" },
  { icon: <Award size={20} />, text: "15 лет опыта" },
  { icon: <Clock size={20} />, text: "Без очередей" },
];
...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden bg-brand-900">
      {/* Animated Background Paths — constrained to top half on mobile */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div>
            ...
            <HeroReveal delay={0.3} className="text-lg text-brand-silver mb-8 max-w-lg leading-relaxed text-balance">
              Клиника Restom — инновационное оборудование, безболезненное лечение и забота в каждой детали. Доверьте свою улыбку профессионалам.
            </HeroReveal>
          ...
          <HeroReveal delay={0.4}>
            <div className="glass-strong rounded-3xl p-6 sm:p-8 glow max-w-md mx-auto lg:ml-auto">
              <h3 className="text-xl font-bold text-white mb-2">Бесплатная консультация</h3>
              ...
              {submitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-brand-silver text-sm">Скоро свяжемся с вами</p>
                </div>
              ) : (
